...
export function HeroSection() {
  return (
    <section className="container py-8 mx-auto lg:py-16">
      <div className="flex flex-col lg:flex-row items-center gap-6">
        <div className="lg:w-1/3 mb-8 lg:mb-0 lg:pr-8 text-start lg:text-end">
          ...
          <p className="text-md text-[#75716B]">
            Discover a World of Knowledge at Your <br/> Fingertips. Your Daily Dose of Inspiration <br/> and Information.
          </p>
        </div>
        <img
          src={Hero}
          alt="Person with a cat"
          className="h-[530px] object-cover rounded-lg shadow-lg lg:w-1/3 "
        />
